...
for c_idx in range(16):
    ...
    for ts in range(L, EXIST_TABLE.shape[1]-L):
        ...
        #else:
        #    pred_attribute[c_idx][ts] = np.concatenate([pred_attribute_e, pred_attribute_n], axis=0) # (3948, 35) repeat2実験には無いが既知ノードと新規ノードの属性予測の結果を活用する場合
